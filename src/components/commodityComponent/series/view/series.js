...
export default () => {
    return (
        <div>
            <Switch>
                <Route path="/commodity/series/" exact component={Main}/>
                <Route path="/commodity/series/info" exact component={Info}/>
                <Route path="/commodity/series/add" exact component={Add}/>
            </Switch>
        </div>
    );
}