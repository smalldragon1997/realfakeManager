...
export default () => {
    return (
        <div>
            <Switch>
                <Route path="/commodity/express/" exact component={Main}/>
                <Route path="/commodity/express/info" exact component={Info}/>
                <Route path="/commodity/express/add" exact component={Add}/>
            </Switch>
        </div>
    );
}