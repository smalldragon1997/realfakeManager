...
export default () => {
    return (
        <div>
            <Switch>
                <Route path="/commodity/discount/" exact component={Main}/>
                <Route path="/commodity/discount/info" exact component={Info}/>
                <Route path="/commodity/discount/add" exact component={Add}/>
            </Switch>
        </div>
    );
}