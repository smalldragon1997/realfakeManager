...
export default () => {
    return (
        <div>
            <Switch>
                <Route path="/commodity/quality/" exact component={Main}/>
                <Route path="/commodity/quality/info" exact component={Info}/>
                <Route path="/commodity/quality/add" exact component={Add}/>
            </Switch>
        </div>
    );
}